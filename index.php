...
<body>
    ...
    <header id="header">
        ...
        if($data['twitter']!=""){
            ?>
                    <a target="_blank" href="<?=$data['twitter']?>" class="twitter"><i class="bx bxl-twitter"></i></a>
                    <?php
        }    
        if($data['facebook']!=""){
            ?>
                    <a target="_blank" href="<?=$data['facebook']?>" class="facebook"><i class="bx bxl-facebook"></i></a>
                    <?php
        }
      if($data['instagram']!=""){
            ?>
                    <a target="_blank" href="<?=$data['instagram']?>" class="instagram"><i class="bx bxl-instagram"></i></a>
                    <?php
        }
       if($data['skype']!=""){
            ?>
                    <a target="_blank" href="<?=$data['skype']?>" class="skype"><i class="bx bxl-skype"></i></a>
                    <?php
        }
      if($data['linkedin']!=""){
            ?>
                    <a target="_blank" href="<?=$data['linkedin']?>" class="linkedin"><i class="bx bxl-linkedin"></i></a>
                    <?php
        }
      if($data['github']!=""){
            ?>
                    <a target="_blank" href="<?=$data['github']?>" class="github"><i class="bx bxl-github"></i></a>
                    <?php
        } 
        ?>
                </div>
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#resume"><i class="bx bx-file-blank"></i> <span>Pendidikan & Pengalaman Kerja</span></a></li>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            ...
            <p>Saya <span class="typed" data-typed-items="<?php
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        ...
                        <div>
                            <ul class="row">
                                ...
                                <li class="col-lg-5"><i class="icofont-rounded-right"></i> <strong>Phone :</strong> <?=$data['mobile']?></li>
                            </ul>
                        </div>
                        <p>
                            <?=$data['longdesc']?>
    ...
    ?>
        ...
        <section id="resume" class="resume">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Pendidikan & Pengalaman Kerja</h2>
                </div>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            ...
                            <div class="email">
                                ...
                                <h4>Email:</h4>
                                <p><a target="_blank" href="mailto:<?=$data['emailid']?>"><?=$data['emailid']?></a></p>
                            </div>

                            <div class="phone">
                                <i class="icofont-phone"></i>
                                <h4>Call:</h4>
                                <p><a target="_blank" href="https://wa.me/<?=$data['mobile']?>"><?=$data['mobile']?></a></p>
                            </div>
                        </div>
...
-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="credits">
                @Copyright by 
                <a href="#">18111374_RahmatSukmadin<br>TIF-RP-18-CID-A_UASWEB1</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
